...
<Meta
  ...
  argTypes={{
    ...
    width: {
      ...
      description:
        "You can handle the width property of Modal (min-width : 150px).",
    },
    height: {
      name: "height",
      type: { name: "string", required: false },
      description:
        "You can handle the height property of Modal (min-height : 150px)",
    },
    label: {
      name: "label",
      type: { name: "string", required: false },
      description: "Specify the label of Modal",
    },
    title: {
      name: "title",
      type: { name: "string", required: false },
...
<Story id="components-button--default-story" />
